...
const CardModal = ({ cardModalOpen, setCardModalOpen, cardData, setCardData, handleCreateCard }) => {
    const statusColors = {
    ...
    const handleCreateCardWithValidation = () => {
        ...
        handleCreateCard(); // Call the actual creation function
    };
        ...
        <Dialog open={cardModalOpen} onOpenChange={setCardModalOpen}>
            ...
            >
                ...
                <DialogHeader className="space-y-1">
                    ...
                    <p className="text-sm text-gray-500 text-center">Fill in the details below</p>
                </DialogHeader>
                ...
                >
                    ...
                    <div className="space-y-1">
                        ...
                        <Input
                            ...
                            className="border-gray-200 focus:ring-2 focus:ring-indigo-400"
                        />
                    </div>
                ...
                <DialogFooter className="mt-6 flex justify-end">
                    <Button
                        onClick={handleCreateCardWithValidation}
